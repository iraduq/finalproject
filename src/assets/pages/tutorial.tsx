    ...
    <div className="container">
      ...
      <div className="boxes">
        ...
        <div className="box">
          ...
          <p className="piece-count">1 piece</p>
          <p>
            The most powerful piece on the board, the Queen can move any number
            of squares in straight lines or on the diagonal until obstructed by
            another piece.
          </p>
        </div>
        <div className="box">
      ...
      <div className="boxes">
        <div className="box">
          ...
          <p>
            ...
            obstructed by another piece. Each Bishop will always occupy squares
            of the same colour as its starting square.
          </p>
        </div>
        <div className="box">
          <p className="icon">&#x265E;</p>
        ...
        <div className="box">
          ...
          <p>
            ...
            forward one square at a time on the same file, except for its first
            move when it can move two squares forward. On reaching the eighth
            rank a Pawn can be promoted to the value of any other piece.
          </p>
        </div>
      </div>
    </div>
